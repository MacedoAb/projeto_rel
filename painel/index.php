						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$clientes ?>"><a href="clientes"><i class="fa fa-newspaper-o"></i> Clientes</a></li>

									<li class="<?php echo @$usuarios ?>"><a href="usuarios"><i class="fa fa-newspaper-o"></i> Usuários</a></li>

									<li class="<?php echo @$funcionarios ?>"><a href="funcionarios"><i class="fa fa-user"></i> Funcionários</a></li>

									<li class="<?php echo @$fornecedores ?>"><a href="fornecedores"><i class="fa fa-clipboard"></i> Fornecedores</a></li>
							...
							<li class="treeview <?php echo @$menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$acessos ?>"><a href="acessos"><i class="fa fa-list"></i> Acessos</a></li>
							...
							<li class="treeview <?php echo @$menu_financeiro ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$receber ?>"><a href="receber"><i class="fa fa-dollar"></i> Receber</a></li>

									<li class="<?php echo @$pagar ?>"><a href="pagar"><i class="fa fa-credit-card-alt"></i> Despesas</a></li>

									<li class="<?php echo @$rel_financeiro ?>"><a href="" data-toggle="modal" data-target="#modalRelFin"><i class="fa fa-file-text-o"></i> Relatório Financeiro</a></li>


									<li class="<?php echo @$rel_sintetico_despesas ?>"><a href="" data-toggle="modal" data-target="#modalRelSinDesp"><i class="fa fa-file-text-o"></i> Rel Sintético Despesas</a></li>

										<li class="<?php echo @$rel_sintetico_receber ?>"><a href="" data-toggle="modal" data-target="#modalRelSinRec"><i class="fa fa-file-text-o"></i> Rel Sintético Receber</a></li>


									<li class="<?php echo @$rel_balanco ?>"><a href="rel/balanco_anual_class.php" target="_blank"><i class="fa fa-file-text-o"></i> Rel Balanço Anual</a></li>
